...
var FaceInstance  = function FaceInstance(_action, _publisherPublicKeyDigest, _faceID, _ipProto,
					  _host, _port, _multicastInterface, _multicastTTL, _freshnessSeconds) {
    this.action = _action;
 ...
 */
FaceInstance.prototype.from_ccnb = function(decoder) {
 ...
 */
FaceInstance.prototype.to_ccnb = function(encoder) {
