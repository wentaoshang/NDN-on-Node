...
Interest.prototype.matches_name = function (/*Name*/ name)
{
	...
	if (this.selectors.minSuffix != null &&
            !(name.components.length - this.name.components.length >= this.selectors.minSuffix))
            return false;

	if (this.selectors.maxSuffix != null &&
            !(name.components.length - this.name.components.length <= this.selectors.maxSuffix))
            return false;
    

	if (this.selectors.exclude != null && name.components.length > this.name.components.length &&
	    this.selectors.exclude.matches (name.components[this.name.components.length]))
	    return false;
    }
